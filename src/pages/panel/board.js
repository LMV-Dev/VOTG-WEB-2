...
//STEP
import BoardMain from '@components/pn/board-main'
...
const PanelBoard = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            await axios
                ...
                .post(`https://api.koaiarchitecture.com/panel/answer/all`, {
    ...
    return (
        <>
            ...
            >
                <BoardMain answerAllData={answerAllData} />
            </Container>
        </>
    )
}

PanelBoard.getLayout = (page) => (
    <PanelGuard>
