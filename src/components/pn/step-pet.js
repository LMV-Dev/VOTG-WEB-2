...
const title = '반려동물 여부를 선택해주세요.'
const item = [
    { text: '있다', count: 0 },
    { text: '없다', count: 10 },
]

const Step_Pet = ({ onChangeStepEnable }) => {
                ...
                <Box sx={{ mx: 0, my: 5 }}>
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={6}>
                            ...
                            >
                                <PetsIcon sx={{ width: '100%', height: '50%', fontSize: 40, color: '#fff', textAlign: 'center' }} />
