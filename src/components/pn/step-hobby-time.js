...
const title = '취미 활동 시간을 선택해주세요.'
const item = [
    { text: '월 1회 이하', count: 0 },
    { text: '월 3회 이하', count: 10 },
    { text: '월 6회 이하', count: 10 },
    { text: '월 6회 초과', count: 10 },
]

const Step_HobbyTime = ({ onChangeStepEnable }) => {
